...
from tools import get_cpu_usage, get_disk_usage
...
class Assistant(Agent):
    ...
    _BASE_INSTRUCTIONS: str = (
        ...
        "You're name is Poco" \
        "IMPORTANT: Never use markdown formatting in your responses. Respond in plain text." \
    )
    ...
    def __init__(
        ...
        super().__init__(
            ...
            tools=[EndCallTool(), get_cpu_usage, get_disk_usage],
        )